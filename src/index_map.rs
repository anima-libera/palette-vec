...
impl IndexMap {
    ...
    pub(crate) fn remove_all_with_opsk(&mut self, opsk_value_to_remove: Opsk) {
        match &mut self.inner {
            IndexMapEnum::U16(map_sized_u16) => {
                ...
                map_sized_u16.remove_all_with_opsk(opsk_value_to_remove);
            }
            IndexMapEnum::U32(map_sized_u32) => {
                // If the opsk doesn't fit in the current number type then there are none.
                ...
                map_sized_u32.remove_all_with_opsk(opsk_value_to_remove);
            }
            IndexMapEnum::U64(map_sized_u64) => {
                map_sized_u64.remove_all_with_opsk(opsk_value_to_remove.value as u64)
            }
        }
    }
    ...
    N: NumberType,
{
    ...
    fn remove_all_with_opsk(&mut self, opsk_value_to_remove: N) {
...
mod tests {
    ...
    fn remove_all_with_opsk() {
        ...
        index_map.remove_all_with_opsk(Opsk::with_value(1));
        assert_eq!(index_map.get(0), Some(Opsk::with_value(0)));
